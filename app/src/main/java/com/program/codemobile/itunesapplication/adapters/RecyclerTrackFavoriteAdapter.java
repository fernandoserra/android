...
public class RecyclerTrackFavoriteAdapter extends RecyclerView.Adapter<RecyclerTrackFavoriteAdapter.DataHolder> {

    private static final String TAG = "RecyclerTrackFavoriteAdapter";
    private Context context;
    List<Results> listResults;

    public RecyclerTrackFavoriteAdapter(Context context, List<Results> listResults) {
    ...
    public DataHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new RecyclerTrackFavoriteAdapter.DataHolder(view);
    }
